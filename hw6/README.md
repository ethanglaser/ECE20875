...
Please refresh your memory of regular expressions using the [class notes](http://www.cbrinton.net/ECE20875-2020-Fall/W7/regexes.pdf). You may also find the Python [documentation on regular expressions](https://docs.python.org/3.6/library/re.html) useful.
